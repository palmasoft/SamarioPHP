...
<html lang="es">
    <head>
        ...
        <title>Instalación Completada - SamarioPHP</title>
    ...
    <body>
        <div class="contenedor">
            ...
            <section>
                ...
                <div class="resultado-instalacion">
                    <h4>Resultado de las Migraciones:</h4>
                    <pre>{{ salidaMigraciones }}</pre>

                    <h4>Resultado de las Seeders:</h4>
                    <pre>{{ salidaSeeders }}</pre>
                </div>
                {% endif %}
            </section>
